    ...
    return (
        <div>
            ...
            <div className="hero-content justify-between flex-col lg:flex-row-reverse">
                ...
                <img src="https://i.ibb.co/ggL9VPT/job-hiring-vacancy-team-interview-career-recruiting.jpg" className="lg:max-w-md mx-auto rounded-lg shadow-2xl" />
                </div> 
                <div className=''>
                <h1 className="text-5xl font-bold text-[#674AC2]">How it Works?</h1>
